...
precip_futura <- chelsa_climate(period = "future", variable = "prec", meses = 1:12,
...
tmax_futura <- chelsa_climate(period = "future", variable = "tmax", meses = 1:12,
                              scenario_string = "rcp45", model_string = "CCSM4", future_years = "2041-2060")

p_anual_crop <- crop(precip_actual, andalucia)


p_anual_mask <- mask(p_anual_crop, andalucia)
